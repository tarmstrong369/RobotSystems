...
class Picarx(object):
    ...
    def backward(self, speed):
        ...
        if current_angle != 0:
            ...
            if (current_angle / abs_current_angle) > 0:
                ...
                self.set_motor_speed(2, speed ) #removed power scaling
            else:
                self.set_motor_speed(1, -1*speed ) #removed power scaling
                self.set_motor_speed(2, speed)
        else:
            self.set_motor_speed(1, -1*speed)
            self.set_motor_speed(2, speed)
    ...
    def forward(self, speed):
        ...
        if current_angle != 0:
            ...
            if (current_angle / abs_current_angle) > 0:
                ...
                self.set_motor_speed(1, speed)
                self.set_motor_speed(2, -1*speed) #removed power scaling
    ...
    def drive(self, speed):
        ...
        v_diff = round((trackwidth*speed*np.tan(np.deg2rad(theta)))/(2*wheelwidth))

        # Set motor speed
        self.set_motor_speed(1, speed - v_diff)
        self.set_motor_speed(2, -(speed + v_diff))

    def turning(self, theta_desired):
        ...
        dir = np.sign(theta_desired - theta)
